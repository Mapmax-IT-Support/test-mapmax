      ...
      >
        ...
        >
          ...
          >
            <div style={{ display: "flex" }}>
              ...
              >
                ...
                ></Form.Control>
                <Button
                  disabled={this.state.browserZip.length == 0}
              ...
              >
                <span style={{ marginRight: "1em" }}>Listing Type</span>
                <Form.Control
            ...
            <div style={{ display: "flex", flexDirection: "row" }}>
              <div style={{ margin: "0 1.5em 0 0" }}>
                <Button
                  disabled={this.state.zip.length == 0}
          ...
          >
            ...
            {!this.state.loading && (
              <span style={{ paddingBottom: "0.5em", paddingRight: "0.5em" }}>
                {this.state.listings.length} results found
              </span>
            )}
          </div>
          {this.state.loading && (
          ...
          {!this.state.loading &&
            this.state.listings.map((listing, i) => {
              return <ListingItem listing={listing} index={i} />;
            })}
          {!this.state.loading && this.state.listings.length == 0 && (
            ...
            >
              <p>Sorry, there are no listings yet for these parameters</p>
            </div>
          )}
