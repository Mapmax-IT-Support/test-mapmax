...
import miles3yellow from '../../../images/Maps/3_MILES.png' 
import miles5blue from '../../../images/Maps/5_MILES.png'
import miles025teal from '../../../images/Maps/0.25_MILES.png'
import miles05purple from '../../../images/Maps/0.5_MILES.png'
...
export function renderInfoContent(place) {
  ...
  <div id="content">
    <div id="siteNotice">
      ...
      <br></br>
      <img style={{display: 'block',  marginRight: 'auto', marginLeft: 'auto', width: '10%'}}src={photo_url}></img> 
      <br></br>
      <div id="bodyContent">
...
export const YELLOW_DOT_25 = miles025teal
export const YELLOW_DOT_3 = miles3yellow
export const BLUE_DOT_05 = miles05purple
export const BLUE_DOT_5 = miles5blue
