...
const MyVerticallyCenteredModal = (props) => {
  return (
    ...
    >
      ...
      <Modal.Body>
        <h3 style={{ fontSize: "20px" }}>1. Zip Code and Tradezone</h3>
        <p style={{ marginLeft: "1em" }}>
          <p>
            <strong> Zip Codes </strong>
            <br></br>
            <span style={{ fontSize: 14 }}>
              Zip codes may contain visible gaps, especially in urban areas.
              This will occurr in the special case of a designated zip code for
              a particular building or complex such as Penn Station or the
          ...
          <p>
            ...
            <br></br>
            <span style={{ fontSize: 14 }}>
              The 'Trade Zone' is calculated by aggregating the set of census{" "}
              <a href="https://www2.census.gov/geo/pdfs/education/CensusTracts.pdf">
                tracts{" "}
              </a>
              that fall within a radius of 1 mile for 'driving' and 0.25 miles
              for 'walking.'
            </span>
            <br></br>
            <span style={{ fontSize: 14 }}>
              Note that results may vary if location is bordering areas not
              within the following locations:{" "}
            </span>
            <br></br>
            <span>
              <strong style={{ fontSize: 14 }}>
                New Jersey, the 5 boroughs of New York City, and Long Island
              </strong>{" "}
            </span>
          </p>
        </p>
        <h3 style={{ fontSize: "20px" }}>2. Statistics</h3>
        <p style={{ marginLeft: "1em" }}>
          <p>
            <span style={{ fontSize: 14 }}>
              Demographics statistics are calculated using the U.S. Census's{" "}
